...
class TTMImageLoader(torch.utils.data.Dataset):
    def __init__(self, img_path, audio_path, file_list, img_json, audio_json,
                 stride=1, mode='train', transform=None, args=None):
    ...
    def __getitem__(self, indices):
        ...
        # print('dataset shape',source_video.shape, source_audio.shape)
        return {'video':source_video, 'audio':source_audio}, target
    ...
    def _get_video(self, index, debug=False):
        ...
        for i in range(start_frame, end_frame + 1):
            ...
            if key in self.face_crop[uid]:
                ...
                bbox = [int(resize_ratio*j) for j in self.face_crop[uid][key]]
