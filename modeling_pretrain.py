...
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
        ...
        self.patch_embed = PatchEmbed( # 这个方法居然在fintune里面
...
class PretrainVisionTransformerDecoder(nn.Module):
    ...
    def __init__(self, patch_size=16, num_classes=768, embed_dim=768, depth=12,
        ...
        super().__init__()
        self.num_classes = num_classes
        assert num_classes == 3 * tubelet_size * patch_size ** 2  # 输入前的tublet的patch大小(RGB)
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other models
...
class PretrainVisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = PretrainVisionTransformerEncoder(
            ...
            in_chans=encoder_in_chans, # 3: rgb
        ...
        self.decoder = PretrainVisionTransformerDecoder(
            ...
            depth=decoder_depth, #4
            num_heads=decoder_num_heads,  #6
            mlp_ratio=mlp_ratio, 
            qkv_bias=qkv_bias, 
            qk_scale=qk_scale, 
            drop_rate=drop_rate, 
        ...
        self.pos_embed = get_sinusoid_encoding_table(self.encoder.patch_embed.num_patches, decoder_embed_dim) # decoder也是需要position embedding的
