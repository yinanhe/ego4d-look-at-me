...
def get_args():
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['Kinetics-400', 'SSV2', 'UCF101', 'HMDB51', 'Diving48','image_folder'],
...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        if 'pos_embed' in checkpoint_model:
        ...
        elif args.input_size != 224 or args.num_frames != 16:  # 需要插值
            ...
            pos_tokens = torch.nn.functional.interpolate(
                pos_tokens, size=(new_T, new_P, new_P), mode='trilinear')
            pos_tokens = pos_tokens.permute(0, 2, 3, 4, 1)  # B,T,H,W,C
            pos_tokens = pos_tokens.flatten(1, 3)  # B, L, C
